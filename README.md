...
- [x] **Sobre mí**: bio real (5+ años freelance, Mar del Plata, inglés C2 oral/B2 escrito), sección "Cómo llegué acá" (recorrido real: data engineering → backend → ML/AI → frontend), Stack agrupado por capa y lenguaje, proyectos separados en "productos propios" / "para clientes", sección "Fuera del código" (LoL, pool, D&D, gastronomía — conectada a Costea) con CTA a contacto — [page.tsx](frontend/app/sobre-mi/page.tsx)
